...
HD_PWD='C:/Users/arjun/Desktop/SRIP/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_control_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_control_unit.tcl -notrace
