...
HD_PWD='C:/Users/arjun/Desktop/SRIP/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_control_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_control_unit.tcl
